...
(function($, document, Math, devicePixelRatio) {
  ...
  PeityPrototype.prepareCanvas = function(width, height, tooltip) {
  ...
  peity.register(
    ...
    function(opts) {
      ...
      var canvas = this.prepareCanvas(opts.width || opts.diameter, opts.height || opts.diameter, opts.tooltip)
